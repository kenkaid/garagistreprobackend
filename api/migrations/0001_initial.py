# Generated by Django 6.0.4 on 2026-04-16 09:51
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('part_location', models.CharField(blank=True, max_length=255)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_active', models.BooleanField(default=True)),
                ('mechanic', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='subscriptions', to='api.mechanic')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('found_dtcs', models.ManyToManyField(to='api.dtcreference')),
                ('mechanic', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='api.mechanic')),
